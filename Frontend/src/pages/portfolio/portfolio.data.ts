...
export const profile = {
  ...
  tagline:
    'I build scalable, performant, and user-friendly web applications with modern technologies.',
  about: [
  ...
  softSkills:
    'Able to read technical documents in English, with strong communication, teamwork, self-learning, and problem-solving skills.',
} as const;
...
export const skillGroups: SkillGroup[] = [
  ...
  {
    label: 'DevOps',
    skills: ['Linux', 'Ubuntu', 'Docker', 'AWS', 'GCP', 'Jenkins', 'CI/CD'],
  },
  {
    label: 'Others',
...
export const projects: PortfolioProject[] = [
  {
    ...
    teamSize: 1,
    summary:
      'A scalable food ordering and dine-in platform with integrated payments and QR-code table session management.',
    technologies: [
      'Next.js',
      'NestJS',
      'TypeScript',
  ...
  },
  {
    ...
    teamSize: 1,
    summary:
      'A NestJS-based weather forecast website with automatic city detection and global weather search.',
